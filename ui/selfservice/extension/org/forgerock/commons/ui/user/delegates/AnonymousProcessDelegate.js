...
define(["jquery", "underscore", "org/forgerock/commons/ui/common/main/AbstractDelegate", "org/forgerock/commons/ui/common/util/Constants"], function ($, _, AbstractDelegate, Constants) {
    ...
    */
    submitParamsIfNeeded = function submitParamsIfNeeded(response, input) {
        var promise = $.Deferred(),
            parameterKeys;
        if (response.type === "parameters") {
            parameterKeys = _.intersection(_.keys(input), _.keys(response.requirements.properties));
    ...
    AnonymousProcessDelegate.prototype.start = function (beginningInput) {
        ...
        if (!this.lastResponse) {
            ...
            // the presence of lastResponse means this can be treated as more of a "resume" than a start
    ...
    AnonymousProcessDelegate.prototype.submit = function (input) {
        ...
        return promise.then(_.bind(function (response) {
            ...
            this.lastResponse = response;
            return response;
        }, this), _.bind(function (errorResponse) {
            delete this.token;
